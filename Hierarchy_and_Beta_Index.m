...
%savepaths
savepath_fig = '/Volumes/EXTENSION/Uni/NBP/Eye-Tracking Data/NewResults/newPreProcessing/Valid Subjects/HierarchyIndex/Fittings/';
savepath_Table = '/Volumes/EXTENSION/Uni/NBP/Eye-Tracking Data/NewResults/newPreProcessing/Valid Subjects/HierarchyIndex/Tables/';
savepath_Beta = '/Volumes/EXTENSION/Uni/NBP/Eye-Tracking Data/NewResults/newPreProcessing/Valid Subjects/BetaIndex/';
savepath_Avg = '/Volumes/EXTENSION/Uni/NBP/Eye-Tracking Data/NewResults/newPreProcessing/Valid Subjects/AvgShortestPaths/';

%Graphfolder location
cd '/Volumes/EXTENSION/Uni/NBP/Eye-Tracking Data/NewResults/newPreProcessing/Valid Subjects/graphs/';
...
overviewIndices.HierarchyIndex = HierarchyIndex.HierarchyIndex;
...
if saving_wanted == true
    ...
    save([savepath_Table 'HierarchyIndex_Table.mat'],'HierarchyIndex');
    save([savepath_Beta 'BetaIndex_Table.mat'],'BetaIndex');
    save([savepath_Avg 'AvgShortestPath.mat'],'AvgShort');
